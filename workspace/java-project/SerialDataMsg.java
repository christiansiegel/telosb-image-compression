...
public class SerialDataMsg extends net.tinyos.message.Message {
    ...
    /** Create a new SerialDataMsg of size 128. */
    ...
    public static int offset_data(int index1) {
        int offset = 0;
        if (index1 < 0 || index1 >= 128) throw new ArrayIndexOutOfBoundsException();
        offset += 0 + index1 * 8;
        return (offset / 8);
    }
    ...
    public String getString_data() { 
         char carr[] = new char[Math.min(net.tinyos.message.Message.MAX_CONVERTED_STRING_LENGTH,128)];
         int i;
